...
% 3D reconstruction %
%%%%%%%%%%%%%%%%%%%%% 
function SpheroState = SpheroTCPIPDetectionTracking_Ver1_1(iitr, SpheroState, CameraParam, SpheroTCPIP)
...
if iitr == 1 % In the first iteration  
    ...
    if SpheroTCPIP.server == 1
        ...
        [posWorldOrder, SpheroTCPIP.gains, SpheroState.Adj, SpheroState.Dd, bboxesOrder, InitFrames, SpheroState.SphFlag] = ...
            Sphero_Client_Ver1_2(SpheroTCPIP.ip, Sph, CameraParam, SpheroState.numRobLocal)
