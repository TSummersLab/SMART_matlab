function [rob_pos, gains, Adj, Dd, bboxesOrder, InitFrames, is_mine] = Sphero_Client_Ver1_2(ip_server, Sph, numRob, CameraParam, numRobLocal)
...
received = 1;
send_over_tcpip(client, received);
fclose(client);
